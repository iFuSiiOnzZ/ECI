...
public class NewsAdapter extends RecyclerView.Adapter<NewsHolder>
{
     ...
     */
    public NewsAdapter(List<NewsInfo> l_NewsInfos, int l_RawLayout, Context l_Context)
    {
     ...
     */
    @Override public NewsHolder onCreateViewHolder(ViewGroup l_ViewGroup, int l_ViewType)
    {
        View l_View = LayoutInflater.from(l_ViewGroup.getContext()).inflate(m_RawLayout, l_ViewGroup, false);
        return new NewsHolder(l_View);
    }
     ...
     */
    @Override public void onBindViewHolder(NewsHolder l_ViewHolder, int l_Location)
    {
        NewsInfo l_NewsInfo = m_NewsInfos.get(l_Location);

        l_ViewHolder.m_PostTitle.setText(Html.fromHtml(l_NewsInfo.m_Title));
        l_ViewHolder.m_PostDescription.setText(Html.fromHtml(l_NewsInfo.m_Excerpt));
